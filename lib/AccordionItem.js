...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        return React.createElement("div", React.__spread({className: "z-accordion-item"},  props, {title: null}), 
                title, 
                body
            )
    },
    ...
    renderTitle: function(props, state) {
        ...
        if (typeof title == 'string'){
            title = React.createElement("span", {className: "z-accordion-item__title", style: {}}, title)
        }
