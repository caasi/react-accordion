...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        return React.createElement("div", React.__spread({className: "rb-accordion-item"},  props, {title: null}), 
                title, 
                body
            )
    },
    ...
    renderTitle: function(props, state) {
        ...
        if (typeof title == 'string'){
            title = React.createElement("span", {className: "rb-accordion-item__title", style: {}}, title)
        }
